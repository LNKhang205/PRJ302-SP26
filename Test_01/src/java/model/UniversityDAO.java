...
public class UniversityDAO {
    ...
    public ArrayList<UniversityDTO> searchByColum(String colum, String value){
        ...
        try {
            ...
            String sql = "SELECT * FROM tblUnversity WHERE " + colum + " =?";
            ...
            while (rs.next()) {                
                ...
                UniversityDTO user = new UniversityDTO(id, name, shortName, description, foundedYear, address, city, region, type, totalStudents, totalFaculties, isDraft, status);
                result.add(user);
            }
